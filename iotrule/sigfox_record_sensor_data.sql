/*
Record sensor data for all SIGFOX
devices defined in
config.state.reported.sigfox_devices.
Ensure that iot.amazonaws.com and
lambda.amazonaws.com are trusted by
role lambda_iot.
